...
# Fixed-scale calibration for Matterport3D + Stanford2D3D:
#   direct panorama depth
# vs
#   perspective monocular depth -> DreamScene360/PanoGeo panorama fusion.
#
# The first N samples from each dataset estimate one fixed dataset scale. The
# remaining samples are evaluated without per-image GT alignment.
...
RAW_DIRECT_DIR="${RAW_DIRECT_DIR:-panorama_depth_eval_da3_direct_mp_s2d3d_fixedscale_raw}"
RAW_FUSION_DIR="${RAW_FUSION_DIR:-panorama_depth_eval_dreamscene360_pano_geo_da3_p24_i100_mp_s2d3d_fixedscale_raw}"
FIXED_DIRECT_DIR="${FIXED_DIRECT_DIR:-panorama_depth_eval_da3_direct_mp_s2d3d_fixedscale_calib${CALIBRATION_COUNT_PER_DATASET}}"
FIXED_FUSION_DIR="${FIXED_FUSION_DIR:-panorama_depth_eval_dreamscene360_pano_geo_da3_p24_i100_mp_s2d3d_fixedscale_calib${CALIBRATION_COUNT_PER_DATASET}}"
COMPARE_DIR="${COMPARE_DIR:-panorama_depth_compare_mp_s2d3d_fixedscale_calib${CALIBRATION_COUNT_PER_DATASET}_fusion_vs_direct}"

RAW_DIRECT_LABEL="${RAW_DIRECT_LABEL:-DA3-Direct-MP-S2D3D-RawForFixedScale}"
RAW_FUSION_LABEL="${RAW_FUSION_LABEL:-DreamScene360-PanoGeo-DA3-P${PANO_GEO_NUM_PERSPECTIVES}-I${PANO_GEO_ITERS}-MP-S2D3D-RawForFixedScale}"
FIXED_DIRECT_LABEL="${FIXED_DIRECT_LABEL:-DA3-Direct-MP-S2D3D-FixedScale-Calib${CALIBRATION_COUNT_PER_DATASET}}"
FIXED_FUSION_LABEL="${FIXED_FUSION_LABEL:-DreamScene360-PanoGeo-DA3-P${PANO_GEO_NUM_PERSPECTIVES}-I${PANO_GEO_ITERS}-MP-S2D3D-FixedScale-Calib${CALIBRATION_COUNT_PER_DATASET}}"
